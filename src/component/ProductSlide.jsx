...
import { faStar, faSearch, faCartShopping } from "@fortawesome/free-solid-svg-icons";
                ...
                <Card.Body className='d-flex flex-column justify-content-between flex items-center justify-center relative'>
                  ...
                  {hoverIndex === index && (
                    <div className='middle flex align-items-center justify-content-center gap-2'>
                      ...
                      <span className="bg-white d-flex items-center justify-content-center px-2 py-2 text-black" style={{
                        borderRadius: '50px',
                      }}>
                      ...
                      <span className="bg-white flex align-items-center justify-content-center px-2 py-1 text-black" style={{
                        borderRadius: '50px',
                      }}>
                        <FontAwesomeIcon style={{ color: "black", fill:"none" }} icon={faCartShopping} />
                      </span>
